...
<?php
    if( isset($_POST["sua"]) ) {
        ...
        $qr = mysqli_query($mysqli, "UPDATE tin SET TieuDe = '$TieuDe', TieuDe_KhongDau = '$TieuDe_KhongDau', TomTat = '$TomTat', AnHien = '$AnHien', idTL = '$idTL', urlHinh = '$urlHinh', idUser = '$idUser', SoLanXem = '$SoLanXem', Content = '$Content', TinNoiBat = '$TinNoiBat', idLT = '$idLT' WHERE idTin = $idTin ");
            ...
            <td>
                <form method="POST">
                    <table width="500px" border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>TieuDe</td>
                            <td><input type="text" id="TieuDe" name="TieuDe" value="<?php echo $row_tin["TieuDe"] ?>"></td>
                        </tr>
                        <tr>
                            <td>TomTat</td>
                            <td><textarea cols="45" rows="5" id="TomTat" name="TomTat" value="<?php echo $row_tin["TomTat"] ?>"></textarea></td>
                        </tr>
                        <tr>
                            <td>urlHinh</td>
                            <td>
                                <input type="text" id="urlHinh" name="urlHinh" value="<?php echo $row_tin["urlHinh"] ?>">
                        ...
                        <tr>
                            <td>Content</td>
                            <td>
                                <textarea id="Content" name="Content" value="<?php echo $row_tin["Content"] ?>"></textarea>
                                <script type="text/javascript">
                        ...
                        <tr>    
                            <td>TinNoiBat</td>
                            <td>
                                <input type="radio" name="TinNoiBat" id="TinNoiBat1" value="1" <?php if($row_tin["TinNoiBat"]==1) echo "checked='checked'"; ?>>Noi Bat
                                <input type="radio" name="TinNoiBat" id="TinNoiBat0" value="0" <?php if($row_tin["TinNoiBat"]==0) echo "checked='checked'"; ?>>Binh Thuong
                            </td>
                        </tr>
                        <tr>    
                            <td>AnHien</td>
                            <td>
                                <input type="radio" name="AnHien" id="AnHien0" value="0" <?php if($row_tin["AnHien"]==0) echo "checked='checked'"; ?>>An
                                <input type="radio" name="AnHien" id="AnHien1" value="1" <?php if($row_tin["AnHien"]==1) echo "checked='checked'"; ?>>Hien
                            </td>
                        </tr>
                        <tr>
                            <td></td>
